...
public class Application {
    ...
    public int run(final String param) {
        ...
        switch (param) {
            ...
            case USER_CREATE: return userController.addUser(getCurrentUserRole());
            case USER_CLEAR: return userController.clearUser(getCurrentUserRole());
            case USER_LIST: return userController.listUser(getCurrentUserRole());
            case USER_VIEW_BY_ID: return userController.viewUserById(getCurrentUserRole());
            case USER_VIEW_BY_INDEX: return userController.viewUserByIndex(getCurrentUserRole());
            case USER_VIEW_BY_LOGIN: return userController.viewUserByLogin(getCurrentUserRole());
            case USER_REMOVE_BY_ID: return userController.deleteUserById(getCurrentUserRole());
            case USER_REMOVE_BY_INDEX: return userController.deleteUserByIndex(getCurrentUserRole());
            case USER_REMOVE_BY_LOGIN: return userController.deleteUserByLogin(getCurrentUserRole());
            case USER_UPDATE_BY_ID: return userController.updateUserById(getCurrentUserRole());
            case USER_UPDATE_BY_INDEX: return userController.updateUserByIndex(getCurrentUserRole());
            case USER_UPDATE_BY_LOGIN: return userController.updateUserByLogin(getCurrentUserRole());
